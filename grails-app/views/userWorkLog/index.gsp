            ...
            <div class="panel panel-default">
                <nav class="navbar navbar-default" role="navigation" style="margin-bottom: 2px;">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="javascript:void(0);">工作日志</a>
                    </div>
                    ...
                    <button type="button" class="btn btn-default navbar-btn" onclick="updateWork()">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <g:if test="${userWorkLogInstanceCount > 30}">
                        <tr>
                            <td colspan="5" style="text-align: center;"><ul class="pagination">
                                <ocse:paginate total="${userWorkLogInstanceCount}" params="${params}"/>
                            </ul></td>
                        </tr>
                    </g:if>
                    </tbody>
