		...
		<div id="list-recipient" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="recipient.infoData.label" default="Info Data" /></th>
					
						<th><g:message code="recipient.user.label" default="User" /></th>
				...
				<g:each in="${recipientInstanceList}" status="i" var="recipientInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${recipientInstance.id}">${fieldValue(bean: recipientInstance, field: "infoData")}</g:link></td>
					
						<td>${fieldValue(bean: recipientInstance, field: "user")}</td>
